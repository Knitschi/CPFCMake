...
function( cpfSetIDEDirectoriesForTargetSources targetName )
	...
	getRelativePathesForSourceFilesInDir( sourcesFiles ${targetName} ${sourceDir})
	# get the generated source files in the binary directory
	get_target_property( binaryDir ${targetName} BINARY_DIR)
	getRelativePathesForSourceFilesInDir( generatedFiles ${targetName} ${binaryDir})
	...
	cpfPrependMulti( generatedFiles "${binaryDir}/" "${generatedFiles}")
