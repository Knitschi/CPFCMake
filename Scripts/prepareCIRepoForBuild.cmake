    ...
    while(NOT pushedChanges)
        ...
        if(EXISTS "${ROOT_DIR}/Sources/.clang-format")
            ...
            if(NOT CONFIG)
                ...
                cpfExecuteProcess( unused "conan install -pr Sources/CIBuildConfigurations/ConanProfile-${CONFIG} -if Configuration/${CONFIG} Sources --build=missing" ${ROOT_DIR})
